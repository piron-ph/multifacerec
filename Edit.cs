    ...
    public partial class Edit : Form
    {
        ...
        private void update_btn_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (u_username.Text == "" || u_lname.Text == "" || u_fname.Text == "" || u_mname.Text == "" || u_gender.Text == "" || u_brgy.Text == "" || u_municiplty.Text == "" || u_province.Text == "" || u_contact.Text == "" || u_usertype.Text == "" || u_reg_date.Text == "")
                {
